...
# print(os.environ)
#MONGODB_URL_KEY=mongodb+srv://sreenivassaiaic:sreenu9999@cluster0.t97uc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0
#"MONGODB_URL", "default_value_if_not_set"
# print(os.getenv)
# MONGODB_URL = os.getenv("MONGODB_URL_KEY")
# print("MONGODB +++++",MONGODB_URL)
# # #import os
# print("MONGODB_URL_KEY:", os.getenv("MONGODB_URL"))
...
print("MONGODB KEY ++++",MONGODB_URL_KEY)
